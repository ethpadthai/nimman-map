...
const markers = [
  { coords: [centerX - distanceFromCenter, centerY - distanceFromCenter], popup: '<b>Hello world!</b><br>I am a popup at Top-Left Marker.' },
  { coords: [centerX - distanceFromCenter, centerY + distanceFromCenter], popup: '<b>Hello world!</b><br>I am a popup at Top-Right Marker.' },
  { coords: [centerX + distanceFromCenter, centerY - distanceFromCenter], popup: '<b>Hello world!</b><br>I am a popup at Bottom-Left Marker.' },
  { coords: [centerX + distanceFromCenter, centerY + distanceFromCenter], popup: '<b>Hello world!</b><br>I am a popup at Bottom-Right Marker.' },
];
